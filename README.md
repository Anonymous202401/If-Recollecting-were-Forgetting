...
| Remove 10%    Wine Data | Distance (±std)                    | Unlearning time (Second) | Storage (MB) | Precomputing time (Second) |
| -------------------- | -------------------------- | ------------------------ | ------------ | -------------------------- |
