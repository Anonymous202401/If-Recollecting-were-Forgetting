...
We have conducted experiments with a multilayer perceptron (MLP) with two fully connected layers on additional datasets, including **Adult**, **Wine**, **Credit**, and **Cancer Disease**, for tasks such as income classification, wine quality prediction, credit card fraud detection, and cancer disease prediction, respectively.
