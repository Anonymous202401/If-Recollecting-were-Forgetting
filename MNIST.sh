...
for seed in 42 930 124 114514 3407 5 1; do
    for num_forget in 10 50 100 150 200 250 300; do
        python3 -u main_proposed.py --model logistic --dataset mnist --epochs 50  --num_dataset 1000 --batch_size 1000 --num_forget $num_forget --lr 0.05 --clip 10 --gpu 0  --seed $seed
        python3 -u main_NU.py --model logistic --dataset mnist --epochs 50  --num_dataset 1000 --batch_size 1000 --num_forget $num_forget --lr 0.05 --clip 10 --gpu 0  --seed $seed
        python3 -u main_IJ.py --model logistic --dataset mnist --epochs 50  --num_dataset 1000 --batch_size 1000 --num_forget $num_forget --lr 0.05 --clip 10 --gpu 0  --seed $seed
        python3 -u main_retrain.py --model logistic --dataset mnist --epochs 50  --num_dataset 1000 --batch_size 1000 --num_forget $num_forget --lr 0.05 --clip 10 --gpu 0  --seed $seed
        python3 -u main_eva.py --model logistic --dataset mnist --epochs 50  --num_dataset 1000 --batch_size 1000 --num_forget $num_forget --lr 0.05 --clip 10 --gpu 0  --seed $seed
    done
done
